import { profileData, educationsData, experiencesData, skillsData, contactsData } from './data.js';
...
function manipulateEducations(data) {
	let educationsFormalTableColName = content.querySelector('#educations-table-formal');
	let educationsBootcampTableColName = content.querySelector('#educations-table-bootcamp');
...
function manipulateExperiences(data) {
	let experiencesOrgTableColName = content.querySelector('#experiences-table-organizational');
	let experiencesProjectTableColName = content.querySelector('#experiences-table-project');
